...
const About = ({ style = "4", rtl }) => {
  const metadata = rtl ? aboutMetadataRTL : aboutMetadata.bgp;

  return (
    <section className="about-app style-5">
      <div className="container">
        <div className="content text-center">
          <h1 className="color-000 mb-10">{'BGP Provinsi Lampung' }</h1>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-7">
                <div className="img text-center">
                  <img src="/assets/img/projects/prog/bgp.jpg" alt="" className="main-img"/>
                ...
                <div className="info mt-10">
                  <h5 className="lh-4">
                    {'The flexible ways to organize your notes: hashtags, nested notebooks, pinning notes to the top of the note list, etc' }
                  </h5>
                </div>
              </div>
            </div>
