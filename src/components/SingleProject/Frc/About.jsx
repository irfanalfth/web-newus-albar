...
const About = ({ style = "4", rtl }) => {
  const metadata = rtl ? aboutMetadataRTL : aboutMetadata.frc;

  return (
    <section className="about-app style-5">
      <div className="container">
        <div className="content text-center">
          <h1 className="color-000 mb-10">{'Fathir Rent Car' }</h1>
            ...
            <div className="row justify-content-center">
              <div className="col-lg-7">
                <div className="img text-center">
                  <img src="/assets/img/projects/prog/frc.jpg" alt="" className="main-img"/>
